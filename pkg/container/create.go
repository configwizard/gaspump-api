...
func Create(ctx context.Context, cli *client.Client, key *ecdsa.PrivateKey, attributes []*container.Attribute) (*cid.ID, error) {
...
`
	...
	cnr := container.New(
		...
		container.WithOwnerID(wallet.OwnerIDFromPrivateKey(key)),
