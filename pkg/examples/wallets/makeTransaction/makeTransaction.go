...
$ ./balance -wallets ./sample_wallets/wallet.rawContent.go
password is password
`

var (
	walletPath = flag.String("wallets", "./pkg/examples/sample_wallets/wallet.rawContent.go", "path to JSON wallets file")
